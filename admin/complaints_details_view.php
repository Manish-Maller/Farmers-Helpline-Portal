...
<?php include('sidebar.php'); ?>
  ...
  <tbody>
    <?php
include('config.php');
$sql="select * from  complaint_details cd, farmar_details fd,class1officer c where cd.farmar_id=fd.farmar_id and cd.class1officer_id=c.class1officer_id ";
...
?>
   <tr>
    ...
    <?php if($status=='Processing') {?> class="btn btn-primary" <?php }  ?>><?php echo $status;?>
   </td>
